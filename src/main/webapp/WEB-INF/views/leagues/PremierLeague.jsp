...
<body>
	...
	<input type="hidden" value="${schedule}" id="schedule">
	<div class="container">
		<div>
		...
		<div class="main">
			...
			<div class="tables">
				...
				<table class="tablesorter table table-striped table-hover" id="tbl">			 
			      	<thead>
			      		<tr>
			      			<th class="sort-alpha"><button class="ranking" value="ranking">순위</button></th>
